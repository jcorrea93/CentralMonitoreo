...
class MakesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create make" do
    assert_difference('Make.count') do
      post makes_url, params: { make: { activo: @make.activo, category_id: @make.category_id, description: @make.description, nombre: @make.nombre } }
    end
  ...
  test "should update make" do
    patch make_url(@make), params: { make: { activo: @make.activo, category_id: @make.category_id, description: @make.description, nombre: @make.nombre } }
